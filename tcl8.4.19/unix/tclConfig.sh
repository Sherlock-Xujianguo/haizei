...
# build directory.
TCL_BUILD_LIB_SPEC='-L/media/sherlock/DATA/海贼/haizei/tcl8.4.19/unix -ltcl8.4${TCL_DBGX}'
...
# compiled.
TCL_SRC_DIR='/media/sherlock/DATA/海贼/haizei/tcl8.4.19'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/media/sherlock/DATA/海贼/haizei/tcl8.4.19/unix -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/media/sherlock/DATA/海贼/haizei/tcl8.4.19/unix/libtclstub8.4${TCL_DBGX}.a'
